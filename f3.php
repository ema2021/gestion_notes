                ...
                <tbody>
                    ...
                    ?>
                        <tr class="bg-brand/20">
                            ...
                            <td class="px-6 py-4">
                                <?php
                                echo '<a href="?delete=' . $row["id"] . '"class="flex justify-center" alt="supprimer cet element"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-700 hover:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <td class="px-6 py-4 text-right">
                                <?php
                                echo '<a href="f2.php?edit=' . $row["id"] . '" class="font-medium text-blue-700 hover:text-blue-500 hover:underline flex justify-center" alt="delete"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
